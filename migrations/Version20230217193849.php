 ...
 */
final class Version20230217193849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, user_sender_id_id INT NOT NULL, user_recipient_id_id INT NOT NULL, conversation_id_id INT NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_B6BD307FE0AD8BCD (user_sender_id_id), INDEX IDX_B6BD307F39B52963 (user_recipient_id_id), INDEX IDX_B6BD307F6B92BD7B (conversation_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
